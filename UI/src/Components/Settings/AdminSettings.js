...
export default props => {
    ...
    const [data, setData] = useState([...general?._settings?.filter(s => s._type_id === 3)])
    ...
    return (
        <div className="container">
            <div className="details">
                ...
                <h3>Form for modifying admin settings.</h3>
                <h3>Note that these changes will change the person who gets notified about incoming orders.</h3>
            </div>
